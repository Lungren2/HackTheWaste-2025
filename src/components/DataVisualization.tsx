...
export const DataVisualization = () => {
  ...
  const getTranslatedErrorName = (errorKey: string) => {
    const translationMap: { [key: string]: string } = {
      "Big plastic objects": "bigPlasticObjects",
      "Paper-cardboard": "paperCardboard",
      "Packaging that is not empty": "packagingNotEmpty",
      "Complex packaging": "complexPackaging",
      "Female hygiene products": "femaleHygieneProducts",
      "Big foils": "bigFoils",
      Textiles: "textiles",
      Electro: "electro",
    }
    return t(translationMap[errorKey] || errorKey)
  }
                ...
                <div className='flex items-center justify-between'>
                  <div className='flex items-center'>
                    ...
                    <span className='text-gray-800 font-medium'>
                      {getTranslatedErrorName(error.item)}
                    </span>
                  </div>
                  <div className='flex items-center'>
                    <motion.div
